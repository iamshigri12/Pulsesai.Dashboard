...
public abstract class DashboardWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static DashboardWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(DashboardWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<DashboardDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<DashboardDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<DashboardDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<DashboardDbContext, Task<T>> func)
    {
        T result;
