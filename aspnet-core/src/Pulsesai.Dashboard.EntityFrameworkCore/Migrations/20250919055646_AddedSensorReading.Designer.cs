...
namespace Pulsesai.Dashboard.Migrations
{
    ...
    [Migration("20250919055646_AddedSensorReading")]
    partial class AddedSensorReading
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pulsesai.Dashboard.Pulses.SensorReading", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppSensorReadings", (string)null);
                });
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Pulsesai.Dashboard.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Pulsesai.Dashboard.Authorization.Users.User", null)
                        .WithMany("Claims")
